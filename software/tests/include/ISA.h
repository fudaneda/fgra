...
//@yuan: original load_data command
...
//@yuan: modified load_data command
static inline int load_data(void *dram_ptr, int spad_ptr, int len, int fused, int task_id, int dep_type, int logN, int logB)
{
//	uint64_t value;
	// uint64_t rs2 = ((uint64_t) dep_type << 61) | ((uint64_t) task_id << 56) | ((uint64_t) fused << 52) | ((uint64_t) len << 32) | (uint64_t) spad_ptr;
	uint64_t rs2 = ((uint64_t) dep_type << 61) | ((uint64_t) task_id << 56) | ((uint64_t) 0 << 55) | ((uint64_t) logN << 53) | ((uint64_t) logB << 49) | ((uint64_t) fused << 48) | ((uint64_t) len << 32) | (uint64_t) spad_ptr;
	ROCC_INSTRUCTION_SS(0, (uintptr_t) dram_ptr, rs2, LOAD_CMD);
	return 0;
}
//@yuan: original store command
...
static inline int store(void *dram_ptr, int spad_ptr, int len, int fused, int task_id, int dep_type, int logN, int logB)
{
//	uint64_t value;
	uint64_t rs2 = ((uint64_t) dep_type << 61) | ((uint64_t) task_id << 56) | ((uint64_t) logN << 54) | ((uint64_t) logB << 50) | ((uint64_t) fused << 48) | ((uint64_t) len << 32) | (uint64_t) spad_ptr;
	ROCC_INSTRUCTION_SS(0, (uintptr_t) dram_ptr, rs2, STORE_CMD);
	return 0;
}
